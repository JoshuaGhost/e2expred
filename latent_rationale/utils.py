...
class Annotation:
    """
    Args:
        annotation_id: unique ID for this ann element
...
def decorate_with_docs_ids(annotation: Annotation):
    ...
    docids = [annotation.annotation_id.split(":")[0]]  # required for multirc
...
def convert_subtoken_ids_to_tokens(
    ids: List[int], tokenizer: transformers.BertTokenizer, token_mapping=None, exps=None, raw_sentence=None
):
